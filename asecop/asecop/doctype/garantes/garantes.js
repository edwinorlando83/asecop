...
frappe.ui.form.on('Garantes', {
	...
	onload: function (frm) {
		frappe.call({
			method: "asecop.asecop.doctype.dpa.dpa.get_provincias",
			callback: (r) => {
...
function get_cantones(incod_prov, frm) {
	frappe.call({
		method: "asecop.asecop.doctype.dpa.dpa.get_cantones",
...
function get_parroquias(incod_prov, frm) {
	frappe.call({
		method: "asecop.asecop.doctype.dpa.dpa.get_parroquia",
